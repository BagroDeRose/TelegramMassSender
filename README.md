...
Текст сообщения вводится в большое поле в блоке **«Сообщение»**.

Над полем расположена панель форматирования — выделите нужный текст и нажмите соответствующую кнопку:
...
| **S** | Зачёркнутый текст |
| **Spoiler** | Скрытый текст-спойлер (в Telegram он скрыт «под шторкой», пока получатель не нажмёт на него) |
| **Code** | Моноширинный текст «как код» |
| **Code block** | Блок кода (для более крупных фрагментов) |
| **🔗** | Добавить ссылку к выделенному тексту (программа спросит адрес ссылки) |
| **🙂** | Вставить emoji из готового набора |

Всё форматирование, применённое в редакторе, корректно передаётся в Telegram — получатель увидит именно то форматирование, которое вы выбрали.
